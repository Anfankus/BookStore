...
CREATE TABLE `bookInfo` (
  ...
  PRIMARY KEY (`bid`),
  KEY `classid` (`classid`),
  KEY `bname` (`bname`,`author`),
  CONSTRAINT `bookinfo_ibfk_1` FOREIGN KEY (`classid`) REFERENCES `classinfo` (`cid`)
...
-- ----------------------------
BEGIN;
INSERT INTO `bookInfo` VALUES (1, '我喜欢生命本来的样子', '周国平', 34.6, 50, 1);
INSERT INTO `bookInfo` VALUES (2, '浮生六记', '沈复', 28.5, 50, 1);
INSERT INTO `bookInfo` VALUES (3, '自在独行', '贾平凹', 21.5, 50, 1);
...
INSERT INTO `bookInfo` VALUES (8, '西游记', '六小龄童', 200, 50, 1);
...
INSERT INTO `bookInfo` VALUES (12, '史记', '司马迁', 32, 50, 2);
...
-- ----------------------------
BEGIN;
INSERT INTO `bookorder` VALUES (1, 1, 1, 3);
COMMIT;
...
CREATE TABLE `orders` (
  ...
  CONSTRAINT `orders_ibfk_1` FOREIGN KEY (`username`) REFERENCES `userinfo` (`username`)
...
-- ----------------------------
BEGIN;
INSERT INTO `orders` VALUES (1, 'zk', 54, '2019-01-04', '2019-01-04', 0);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `userInfo` VALUES ('hwt', '123', 'asc');
INSERT INTO `userInfo` VALUES ('lee', '123456', 'abc@qq.com');
INSERT INTO `userInfo` VALUES ('ll', '123', 'a');
INSERT INTO `userInfo` VALUES ('zk', '123456', 'sss@126.com');
COMMIT;
